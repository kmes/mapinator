...
fixtures.html = {
  ...
  dataset: ['<div class="tt-dataset-test">', '<span class="tt-suggestions">', '<div class="tt-suggestion"><p>one</p></div>', '<div class="tt-suggestion"><p>two</p></div>', '<div class="tt-suggestion"><p>three</p></div>', '</span>', '</div>'].join('')
};